...
docker buildx build --no-cache --platform linux/amd64 --push -t "marc0janssen/nzbgetvpn:${VERSION}-image-v${IMAGE_VERSION}" -t "marc0janssen/nzbgetvpn:testing" -f ./Dockerfile-testing .
