...
docker buildx build --platform linux/amd64,linux/arm64 --push -t marc0janssen/nzbgetvpn:testing -f ./Dockerfile-testing .
docker buildx build --platform linux/amd64,linux/arm64 --push -t marc0janssen/nzbgetvpn:${VERSION} -f ./Dockerfile-testing .
