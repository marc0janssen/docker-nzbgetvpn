...
| `VPN_SELFTEST_DEBOUNCE_FILE` | No | Absolute path | `/tmp/nzbgetvpn-selftest-debounce` | File storing debounce streak counters for consecutive failures/warnings (atomic, best-effort). |
...
| `VPN_SELFTEST_DEBOUNCE_FILE` | No | Absolute path | `/tmp/nzbgetvpn-selftest-debounce` | Stores consecutive critical/warning streak counters between runs. |
